...
int main(int argc, char *argv[]) {
    ...
    clone_map->fontset.filename = strdup("/home/sean/projects/ms_42/mapserver/tests/fonts.txt");
    ...
    clone_map->symbolset.filename = strdup("/home/sean/projects/ms_42/mapserver/tests/symbols.txt");
