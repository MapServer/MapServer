...
{
  PROTOBUF_C_ASSERT (message->base.descriptor == &vector_tile__tile__descriptor);
...
{
  {
    ...
    0,   /* quantifier_offset */
    PROTOBUF_C_OFFSETOF(VectorTile__Tile__Value, string_value),
    NULL,
    NULL,
    0,            /* packed */
  ...
  },
  {
    ...
    PROTOBUF_C_OFFSETOF(VectorTile__Tile__Value, has_float_value),
    PROTOBUF_C_OFFSETOF(VectorTile__Tile__Value, float_value),
    NULL,
    NULL,
    0,            /* packed */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_OFFSETOF(VectorTile__Tile__Value, has_double_value),
    PROTOBUF_C_OFFSETOF(VectorTile__Tile__Value, double_value),
    NULL,
    NULL,
    0,            /* packed */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_OFFSETOF(VectorTile__Tile__Value, has_int_value),
    PROTOBUF_C_OFFSETOF(VectorTile__Tile__Value, int_value),
    NULL,
    NULL,
    0,            /* packed */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_OFFSETOF(VectorTile__Tile__Value, has_uint_value),
    PROTOBUF_C_OFFSETOF(VectorTile__Tile__Value, uint_value),
    NULL,
    NULL,
    0,            /* packed */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_OFFSETOF(VectorTile__Tile__Value, has_sint_value),
    PROTOBUF_C_OFFSETOF(VectorTile__Tile__Value, sint_value),
    NULL,
    NULL,
    0,            /* packed */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_OFFSETOF(VectorTile__Tile__Value, has_bool_value),
    PROTOBUF_C_OFFSETOF(VectorTile__Tile__Value, bool_value),
    NULL,
    NULL,
    0,            /* packed */
    0,NULL,NULL    /* reserved1,reserved2, etc */
...
static const uint64_t vector_tile__tile__feature__id__default_value = 0;
...
{
  {
    ...
    PROTOBUF_C_LABEL_OPTIONAL,
    PROTOBUF_C_TYPE_UINT64,
    PROTOBUF_C_OFFSETOF(VectorTile__Tile__Feature, has_id),
    PROTOBUF_C_OFFSETOF(VectorTile__Tile__Feature, id),
    NULL,
  ...
  },
  {
    ...
    PROTOBUF_C_OFFSETOF(VectorTile__Tile__Feature, n_tags),
    PROTOBUF_C_OFFSETOF(VectorTile__Tile__Feature, tags),
    NULL,
    NULL,
    1,            /* packed */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_OFFSETOF(VectorTile__Tile__Feature, has_type),
    PROTOBUF_C_OFFSETOF(VectorTile__Tile__Feature, type),
  ...
  },
  {
    ...
    PROTOBUF_C_LABEL_REPEATED,
    PROTOBUF_C_TYPE_UINT32,
    PROTOBUF_C_OFFSETOF(VectorTile__Tile__Feature, n_geometry),
    PROTOBUF_C_OFFSETOF(VectorTile__Tile__Feature, geometry),
    NULL,
    NULL,
    1,            /* packed */
    0,NULL,NULL    /* reserved1,reserved2, etc */
...
static const uint32_t vector_tile__tile__layer__version__default_value = 1;
static const uint32_t vector_tile__tile__layer__extent__default_value = 4096;
...
{
  {
    ...
    PROTOBUF_C_TYPE_STRING,
    0,   /* quantifier_offset */
    PROTOBUF_C_OFFSETOF(VectorTile__Tile__Layer, name),
    NULL,
    NULL,
    0,            /* packed */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_OFFSETOF(VectorTile__Tile__Layer, n_features),
    PROTOBUF_C_OFFSETOF(VectorTile__Tile__Layer, features),
  ...
  },
  {
    ...
    PROTOBUF_C_LABEL_REPEATED,
    PROTOBUF_C_TYPE_STRING,
    PROTOBUF_C_OFFSETOF(VectorTile__Tile__Layer, n_keys),
    PROTOBUF_C_OFFSETOF(VectorTile__Tile__Layer, keys),
    NULL,
    NULL,
    0,            /* packed */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_LABEL_REPEATED,
    PROTOBUF_C_TYPE_MESSAGE,
    PROTOBUF_C_OFFSETOF(VectorTile__Tile__Layer, n_values),
    PROTOBUF_C_OFFSETOF(VectorTile__Tile__Layer, values),
  ...
  },
  {
    ...
    PROTOBUF_C_LABEL_OPTIONAL,
    PROTOBUF_C_TYPE_UINT32,
    PROTOBUF_C_OFFSETOF(VectorTile__Tile__Layer, has_extent),
    PROTOBUF_C_OFFSETOF(VectorTile__Tile__Layer, extent),
    NULL,
  ...
  },
  {
    ...
    PROTOBUF_C_TYPE_UINT32,
    0,   /* quantifier_offset */
    PROTOBUF_C_OFFSETOF(VectorTile__Tile__Layer, version),
    NULL,
...
const ProtobufCEnumValue vector_tile__tile__geom_type__enum_values_by_number[4] =
{
...
const ProtobufCEnumValueIndex vector_tile__tile__geom_type__enum_values_by_name[4] =
{
  { "LINESTRING", 2 },
  { "POINT", 1 },
  { "POLYGON", 3 },
...
{
  {
    ...
    PROTOBUF_C_LABEL_REPEATED,
    PROTOBUF_C_TYPE_MESSAGE,
    PROTOBUF_C_OFFSETOF(VectorTile__Tile, n_layers),
    PROTOBUF_C_OFFSETOF(VectorTile__Tile, layers),
