...
namespace mapserver
{
    ...
    private:
        mapserver::dda_line_interpolator<14> r, g, b, a;
    };
    ...
    private:
        mapserver::dda_line_interpolator<14> v,a;
    };
    ...
    private:
        ...
        typedef mapserver::pod_bvector<color_point, 4> color_profile_type;
        typedef mapserver::pod_array<color_type>       color_lut_type;
