...
if(WIN32)
  ...
  SET(PHP7_POSSIBLE_INCLUDE_PATHS C:/php-sdk/phpmaster/vc${VSCMD_VER}/$ENV{VSCMD_ARG_TGT_ARCH}/php-src C:/projects/mapserver$ENV{VSCMD_ARG_TGT_ARCH}/php-sdk/phpmaster/vc${VSCMD_VER}/$ENV{VSCMD_ARG_TGT_ARCH}/php-src)
endif(WIN32)
