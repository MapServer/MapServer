...
/************************************************************************/
static char *DBFReadAttribute(DBFHandle psDBF, int hEntity, int iField )
...
{
  return(atoi(DBFReadAttribute( psDBF, iRecord, iField )));
}
...
{
  return(atof(DBFReadAttribute( psDBF, iRecord, iField )));
}
